...
def get_recommendation(category, score):
    if category == "Structure":
        if score >= 80:
            return "Roof and structure appear sound. Continue routine inspections."
        elif score >= 60:
            return "Some aging or wear present. Schedule a roof inspection and assess structural joints."
        else:
            return "High wear risk. Prioritize roofing repair or full inspection."
