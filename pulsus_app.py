...
if st.button("Calculate Score"):
    ...
    # Show final score with UI enhancements
    st.markdown("### 🧠 Final PULSUS Score")
    st.markdown(f"<h1 style='text-align:center; font-size: 60px;'>{final_score}%</h1>", unsafe_allow_html=True)
    ...
    st.markdown("---")
    st.caption("🔍 Scores below 60% typically indicate systems or components that need maintenance, replacement, or review.")
