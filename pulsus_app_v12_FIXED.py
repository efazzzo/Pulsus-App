    ...
    with open(filename, newline='') as f:
        ...
        for row in reader:
            ...
            weather[date] = {
                ...
                "precip": float(row["precipitation_sum (in)"])
            }
    return weather
...
metric_templates = {
    "Real Estate": [
        ...
        {"label": "Gutter Cleaning Frequency (e.g. Monthly)", "type": "exact_match", "ideal": "monthly", "weight": 0.1, "category": "Maintenance"},
        {"label": "Fire Extinguisher Last Checked (e.g. June 2023)", "type": "time_since_service", "max_months": 12, "weight": 0.1, "category": "Fire Safety"},
        {"label": "Foundation Cracks Noted (yes/no)", "type": "exact_match", "ideal": "no", "weight": 0.1, "category": "Structural Integrity"},
        {"label": "Smart Thermostat Installed (yes/no)", "type": "exact_match", "ideal": "yes", "weight": 0.05, "category": "Smart Tech"},
        {"label": "Carbon Monoxide Detector Installed (yes/no)", "type": "exact_match", "ideal": "yes", "weight": 0.1, "category": "Safety & Compliance"}
    ]
}
